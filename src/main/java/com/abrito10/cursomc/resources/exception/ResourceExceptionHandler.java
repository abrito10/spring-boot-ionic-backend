package com.abrito10.cursomc.resources.exception;
...
import com.abrito10.cursomc.services.exception.FileException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> objectNotFound(ObjectNotFoundException e, HttpServletRequest request){
		StandardError err = new StandardError(System.currentTimeMillis(), HttpStatus.NOT_FOUND.value(), "Nao Localizado", e.getMessage(), request.getRequestURI());
